...
- TypeScript 5.x (Node.js 20.x LTS, Next.js 16.1.6) + NestJS 11.x, Prisma ORM 7.5.0, React 19.2.3, Radix UI, Tailwind CSS, Zod validation (010-plan-md-spec)
- SQLite (development), PostgreSQL (production), Prisma migrations (010-plan-md-spec)
